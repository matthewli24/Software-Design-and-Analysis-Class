...
class HotspotList
{
    public:
        ...
        /* find() - searches the hotspot list for the record that matches the ObjectId
         * @param int ObjectId [in] - a object id for a WiFi hotspot
         ...
         * */
        int find(int ObjectId, Hotspot &object);
       
        /* findsmallest() - searches the hotspot list for smallest ObjectId
         * @param Hotspot &object [inout] - a valid Hotspot object
         * @pre  - assume a valid hotspotlist exist, and valid Hotspot object given
         * @post - copy the smallest record of the given Hotspot object, which 
         *         is passed by reference and return 1. return 0 if it did not copy over.
         * */
        int findsmallest(Hotspot &object);
         ...
         * @post - returns the root of the sortedlist
         * */
        node<Hotspot>* get_root();
        
        //returns the number of nodes in the BST
        int size();
    private:
        BST<Hotspot> hotspotlist;
};
